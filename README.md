...
This project is an attempt to re-write Pimoron's library https://github.com/pimoroni/unicorn-hat-hd, but 
in Go, and bind it into a RESTful API that can be addressed programatically, and fed dynamic content.
